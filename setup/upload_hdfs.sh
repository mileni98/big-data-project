...
hdfs dfs -copyFromLocal -f ./hospitals.csv /user/root/data-lake/raw/hospitals.csv
hdfs dfs -copyFromLocal -f ./countries.csv /user/root/data-lake/raw/countries.csv